...
const Basket = ({
  ...
  const renderContent = () => (
    <div>
      {isBasketEmpty && <div>Your cart is empty</div>}
  ...
  const renderSidebar = () => (
    <div>
      <Link to='/' className='btn btn-info btn-block'>
        <span className='glyphicon gyphicon-info-sign'></span>
        ...
        <div>
          <div>
            <button onClick={cleanBasket} className='btn btn-danger btn-block'>
              <span className='glyphicon gyphicon-trash'></span>
              Clean cart
            </button>
            <button
            ...
            >
              <span className='glyphicon gyphicon-envelope'></span>
              Checkout
            </button>
          </div>
        </div>
